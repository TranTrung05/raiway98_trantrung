...
public class program6 {
	public static void main(String[] args) {
		...
		account1.groups = group_account1;
		// hien thi phong ban tren he thong
		System.out.println("--------Department---------");
		System.out.println("Department 1 : " + department1.id + " " + department1.name);
		System.out.println("Department 1 : " + department2.id + " " + department2.name);
		System.out.println("Department 1 : " + department3.id + " " + department3.name);
		System.out.println("toString() : " + department1.toString());

		// hien thi thong tin cac Account tren he thong
