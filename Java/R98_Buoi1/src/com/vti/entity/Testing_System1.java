...
public class Testing_System1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Account 1: ID : " + account1.id + "," + " Email: " + account1.email + "," + " UserName: "
				+ account1.username + "," + " FullName: " + account1.fullname + "," + " Department: "
				+ account1.department.name + "," + " Position: " + account1.position.name + "," + " Group: "
				+ account1.groups[0].name + " va " + account1.groups[1].name + "," + "CreateDate: "
				+ account1.CreateDate);
